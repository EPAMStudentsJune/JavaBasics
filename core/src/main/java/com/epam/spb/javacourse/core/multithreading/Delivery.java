...
public class Delivery {
    ...
    // Exchanger (обменник) может понадобиться, для того,
    // чтобы обменяться данными между двумя потоками в определенной точки работы обоих потоков.
    ...
    public static class Car {
        public static final String HHH = "HELLO";
